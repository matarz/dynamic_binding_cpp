...
//always returns 1
int n73::turn_on_or_off()
{
  cout<<"\n** Press the N73 on/off button then hit enter. **\n";
  cin.get();
...
***                            Take a pic                              ***
*************************************************************************/
//adds a picture to n73's pics gallary
...
int n73::take_pic()
{
  ...
  {
    cout<<"\nPicture has been taken and added to your N73's gallary successfully\n";
    return 1;
  }
  else
  {
...
int n73::pic_gallary()
{
  ...
  cin.ignore(10,'\n');
  cout<<"    ** Welcome to n73's picture gallary! **\n";
  ...
  do
  {
    ...
    else if(choice == 2)   //remove
    {
      ...
      if(pics->remove(title))   //check remove result
        cout<<"\nPicture removal from n73's gallary was successful.\n";
      else
        cout<<"\nRemoval failed. \n";
...
{
  cin.ignore(10,'\n');
  cout<<"\nn73: The \"Make a call\" function is not implemented yet.\n";
  cout<<"       Hit enter to go back. ";
  cin.get();
  return 0;
}
...
{
  cin.ignore(10,'\n');
  cout<<"\nn73: The \"Play music\" function is not implemented yet.\n";
  cout<<"       Hit enter to go back. ";
  cin.get();
  return 0;
}
...
{
  cin.ignore(10,'\n');
  cout<<"\nn73: The \"Messages\" function is not implemented yet.\n";
  cout<<"       Hit enter to go back. ";
  cin.get();
  return 0;
}
